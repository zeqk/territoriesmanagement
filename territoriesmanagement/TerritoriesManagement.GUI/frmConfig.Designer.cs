namespace TerritoriesManagement.GUI
{
    partial class frmConfig
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tabTerritories = new System.Windows.Forms.TabPage();
			this.btnRenumberTerritories = new System.Windows.Forms.Button();
			...
			this.tabTerritories.SuspendLayout();
			this.SuspendLayout();
			// 
			// tabConfigs
			// 
			...
			this.tabConfigs.Controls.Add(this.tabTerritories);
			...
			// tabTerritories
			// 
			this.tabTerritories.Controls.Add(this.btnRenumberTerritories);
			this.tabTerritories.Location = new System.Drawing.Point(4, 22);
			this.tabTerritories.Name = "tabTerritories";
			this.tabTerritories.Padding = new System.Windows.Forms.Padding(3);
			this.tabTerritories.Size = new System.Drawing.Size(233, 180);
			this.tabTerritories.TabIndex = 4;
			this.tabTerritories.Text = "Territories";
			this.tabTerritories.UseVisualStyleBackColor = true;
			// 
			// btnRenumberTerritories
			// 
			this.btnRenumberTerritories.Location = new System.Drawing.Point(34, 48);
			this.btnRenumberTerritories.Name = "btnRenumberTerritories";
			this.btnRenumberTerritories.Size = new System.Drawing.Size(163, 23);
			this.btnRenumberTerritories.TabIndex = 0;
			this.btnRenumberTerritories.Text = "Autorenumber territories";
			this.btnRenumberTerritories.UseVisualStyleBackColor = true;
			this.btnRenumberTerritories.Click += new System.EventHandler(this.btnRenumberTerritories_Click);
			// 
			// frmConfig
			// 
			...
			this.tabTerritories.ResumeLayout(false);
		...
		private System.Windows.Forms.TabPage tabTerritories;
		private System.Windows.Forms.Button btnRenumberTerritories;
